...
| Номер лабораторной | Оценка (+/-)  | Состояние работы | Комментарий                          |
| ------------------ | ------------- | ---------------- | ------------------------------------ |
| 1                  | +             | Сдана            | Почитайте про synchronized, volatile |
| 2                  | -             | Выполнена        | Не потребовалась, только 1 нужна     |
...
Подключена сабмодулем.
При клонирование репозитория для подгрузки курсовой выполните:

```bash
cd spbspu-OOP-LabManager-Labs
